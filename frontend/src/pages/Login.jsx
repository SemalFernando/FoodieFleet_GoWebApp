  ...
  return (
    <div className="auth-container">
      <div className="auth-illustration">
        <div>
          <h2 className="illustration-title">Shopping Made Smarter</h2>
          <p className="illustration-text">Scan, shop, and checkout effortlessly.</p>
          {showIllustration ? (
            <img
      ...
      <div className="auth-form-container">
        <div className="auth-form">
          <h1 className="auth-title">Sign in to TURSACart</h1>
          ...
          <div className="social-buttons">
            <button type="button" className="social-button github" onClick={loginWithGithub}>GitHub</button>
            <button type="button" className="social-button google" onClick={loginWithGoogle}>Google</button>
          </div>
