  ...
  return (
    <div className={styles.authContainer}>
      <div className={styles.authIllustration}>
        <div>
          <h2 className={styles.illustrationTitle}>Shopping Made Smarter</h2>
          <p className={styles.illustrationText}>Scan, shop, and checkout effortlessly.</p>
          {showIllustration ? (
            <img
      ...
      <div className={styles.authFormContainer}>
        <div className={styles.authForm}>
          ...
          <div className={styles.socialButtons}>
            <button type="button" className={`${styles.socialButton} ${styles.github}`} onClick={loginWithGithub}>
              GitHub
            </button>
            <button type="button" className={`${styles.socialButton} ${styles.google}`} onClick={loginWithGoogle}>
              Google
            </button>
          </div>
